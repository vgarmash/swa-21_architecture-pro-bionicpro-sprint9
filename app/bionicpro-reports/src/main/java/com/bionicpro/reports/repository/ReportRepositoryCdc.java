 ...
 */
@Repository
public class ReportRepositoryCdc {
    ...
    public ReportRepositoryCdc(JdbcTemplate jdbcTemplate) {
    ...
    public List<UserReport> findByUserId(Long userId) {
        String sql = String.format(
                "SELECT %s FROM user_reports_cdc WHERE user_id = ? ORDER BY report_date DESC",
                SELECT_COLUMNS);
    ...
    public Optional<UserReport> findByUserIdAndReportDate(Long userId, LocalDate reportDate) {
        String sql = String.format(
                "SELECT %s FROM user_reports_cdc WHERE user_id = ? AND report_date = ?",
                SELECT_COLUMNS);
    ...
    public List<UserReport> findLatestByUserId(Long userId, int limit) {
        String sql = String.format(
                "SELECT %s FROM user_reports_cdc WHERE user_id = ? ORDER BY report_date DESC LIMIT ?",
                SELECT_COLUMNS);
    ...
    public List<UserReport> findAll() {
        String sql = String.format(
                "SELECT %s FROM user_reports_cdc ORDER BY report_date DESC",
                SELECT_COLUMNS);
